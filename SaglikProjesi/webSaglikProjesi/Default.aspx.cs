...
namespace webSaglikProjesi
{
    public partial class Default : System.Web.UI.Page
    {
        ...
        cSepet spt = new cSepet();  //Models.cSepet diyede sadece bunun ıcınde yazılabilir
        ...
        {
            //dlstUrunler.EditItemIndex = e.Item.ItemIndex; // primary key yazman gerek key field a datalistin id yakalamak icin
            //int id = Convert.ToInt32(dlstUrunler.SelectedValue);
